...
vim.api.nvim_set_keymap('n', '<C-s>', ':ToggleTerm siz=10<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-f>', ':ToggleTerm direction=float<CR>', { noremap = true, silent = true })
